    ...
    <div className="modal wide breakdown-modal">
      ...
      {phase === "input" ? <>
        <div className="form-grid">
          <label className="form-span"><span>想完成的任務</span><input autoFocus value={title} onChange={(event) => setTitle(event.target.value)} placeholder="例如：完成 NVIDIA AI 工程師求職作品" /></label>
          ...
          {isCreatingProject && <><label><span>新專案名稱</span><input value={newProjectName} onChange={(event) => setNewProjectName(event.target.value)} placeholder="輸入專案名稱，例如：NVIDIA 求職作品庫" /></label>
