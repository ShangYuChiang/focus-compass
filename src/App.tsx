...
import bubuMascot from "./assets/bubu-mascot.png";
import bubuWalk from "./assets/bubu-walk.png";
import bubuYawn from "./assets/bubu-yawn.png";
import bubuStretch from "./assets/bubu-stretch.png";
...
function BubuHomePortrait() {
  return <div className="pet-avatar-wrap">
    <div className="pet-avatar-stage">
      <img className="pet-avatar" src={bubuMascot} alt="以真實咘咘為原型的布偶貓夥伴" />
    </div>
